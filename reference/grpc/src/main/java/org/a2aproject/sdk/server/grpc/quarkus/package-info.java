 ...
 * <ul>
 *   <li>{@link org.a2aproject.sdk.server.grpc.quarkus.QuarkusGrpcHandler QuarkusGrpcHandler} - Main gRPC service implementation</li>
 *   <li>{@link org.a2aproject.sdk.server.grpc.quarkus.A2AExtensionsInterceptor A2AExtensionsInterceptor} - Metadata extraction interceptor</li>
 *   <li>{@link org.a2aproject.sdk.server.grpc.quarkus.QuarkusGrpcTransportMetadata QuarkusGrpcTransportMetadata} - Transport protocol identification</li>
 * </ul>
 *
 * <h2>gRPC Methods</h2>
 *
 ...
 * <ul>
 *   <li>{@link org.a2aproject.sdk.spec.AgentCard AgentCard} with {@code @PublicAgentCard} qualifier</li>
 *   <li>{@link org.a2aproject.sdk.server.agentexecution.AgentExecutor AgentExecutor} implementation</li>
 * </ul>
 *
 * <p><b>Optional CDI Beans:</b>
 * <ul>
 *   <li>{@link org.a2aproject.sdk.spec.AgentCard AgentCard} with {@code @ExtendedAgentCard} qualifier</li>
 *   <li>{@link org.a2aproject.sdk.transport.grpc.handler.CallContextFactory CallContextFactory} for custom context creation</li>
 * </ul>
 *
 * <h2>Usage</h2>
 *
 ...
 * <p>Provide a CDI bean implementing {@link org.a2aproject.sdk.transport.grpc.handler.CallContextFactory CallContextFactory}:
 * <pre>{@code
 * @ApplicationScoped
 ...
 *   <li>{@code context.invocation_metadata()} → {@link org.a2aproject.sdk.transport.grpc.context.GrpcContextKeys#METADATA_KEY}</li>
 *   <li>{@code context.method()} → {@link org.a2aproject.sdk.transport.grpc.context.GrpcContextKeys#GRPC_METHOD_NAME_KEY}</li>
 *   <li>{@code context.peer()} → {@link org.a2aproject.sdk.transport.grpc.context.GrpcContextKeys#PEER_INFO_KEY}</li>
 * </ul>
 *
 * @see org.a2aproject.sdk.server.grpc.quarkus.QuarkusGrpcHandler
 * @see org.a2aproject.sdk.server.grpc.quarkus.A2AExtensionsInterceptor
