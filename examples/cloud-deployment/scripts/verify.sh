...
echo ""
echo "Recommended: Using Minikube tunnel (for load balancing demo)"
echo "  # In one terminal:"
echo "  minikube tunnel"
echo "  "
echo "  # In another terminal:"
echo "  curl http://127.0.0.1:8080/a2a/agent-card"
echo ""
echo "Alternative: Using Minikube service URL"
echo "  minikube service a2a-agent-service -n a2a-demo --url"
echo "  curl \$(minikube service a2a-agent-service -n a2a-demo --url)/a2a/agent-card"
echo "=========================================="
