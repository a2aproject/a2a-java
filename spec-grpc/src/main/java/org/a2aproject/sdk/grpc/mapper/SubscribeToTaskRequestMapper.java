...
/**
 * Mapper between {@link SubscribeToTaskRequest} and {@link org.a2aproject.sdk.grpc.SubscribeToTaskRequest}.
 * <p>
...
public interface SubscribeToTaskRequestMapper {
     ...
     */
    default org.a2aproject.sdk.grpc.SubscribeToTaskRequest toProto(SubscribeToTaskRequest domain) {
        if (domain == null || domain.getParams() == null || domain.getParams().id() == null) {
            return null;
        }
        return org.a2aproject.sdk.grpc.SubscribeToTaskRequest.newBuilder()
     ...
     */
    default SubscribeToTaskRequest fromProto(org.a2aproject.sdk.grpc.SubscribeToTaskRequest proto) {
        if (proto == null || proto.getId()== null) {
            return null;
        }
        return SubscribeToTaskRequest.builder()
                .params(new org.a2aproject.sdk.spec.TaskIdParams(proto.getId()))
                .build();
    }
}
