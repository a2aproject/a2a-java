...
cleanup() {
  ...
  rm -rf src/main/java/itk > /dev/null 2>&1 || true
...
# 3. Build java pb classes on host
mkdir -p src/main/java
protoc -I. --java_out=src/main/java instruction.proto
...
# 5.1. Fix dubious ownership for git
