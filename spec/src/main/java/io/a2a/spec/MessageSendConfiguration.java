...
/**
 * Defines configuration options for a {@code message/send} or
 * {@code message/stream} request.
 *
 * @param acceptedOutputModes    the output content modes the client accepts
 * @param historyLength          optional maximum number of history messages to
 *                               include
 * @param pushNotificationConfig optional push notification configuration for
 *                               task updates
 * @param blocking               whether the request should block until the task
 *                               completes
 */
