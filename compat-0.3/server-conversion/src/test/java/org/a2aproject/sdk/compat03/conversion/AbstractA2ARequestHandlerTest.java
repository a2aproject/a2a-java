 ...
 * to the v1.0 backend via the {@link Convert03To10RequestHandler} conversion layer.
 * </p>
 *
 * <h2>Architecture:</h2>
 * <pre>
 ...
 * the conversion happening transparently in {@link Convert03To10RequestHandler}.
 */
public abstract class AbstractA2ARequestHandlerTest {
    ...
    protected Convert03To10RequestHandler convert03To10Handler;
    ...
    public void init() {
        ...
        convert03To10Handler = new Convert03To10RequestHandler();
