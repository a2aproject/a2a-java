...
/**
 * Test for {@link TaskMapper} to verify conversion of fully populated Task objects
...
class TaskMapperTest {
    ...
    void testFullyPopulatedTaskConversion() {
        ...
        org.a2aproject.sdk.compat03.spec.Message v03Message = new org.a2aproject.sdk.compat03.spec.Message(
            org.a2aproject.sdk.compat03.spec.Message.Role.USER,
            List.of(new org.a2aproject.sdk.compat03.spec.TextPart("Hello, agent!")),
            "msg-001",
            "ctx-001",
            "task-001",
        ...
        org.a2aproject.sdk.compat03.spec.TaskStatus v03Status = new org.a2aproject.sdk.compat03.spec.TaskStatus(
            org.a2aproject.sdk.compat03.spec.TaskState.WORKING,
            v03Message,
            now
        );

        org.a2aproject.sdk.compat03.spec.Artifact v03Artifact = new org.a2aproject.sdk.compat03.spec.Artifact(
            "artifact-001",
            "Test Artifact",
            "A test artifact",
            List.of(
                new org.a2aproject.sdk.compat03.spec.TextPart("Response text"),
                new org.a2aproject.sdk.compat03.spec.DataPart(Map.of("result", "success"))
            ),
            Map.of("artifactMeta", "value"),
            List.of("artifactExt")
        );

        org.a2aproject.sdk.compat03.spec.Message v03HistoryMessage = new org.a2aproject.sdk.compat03.spec.Message(
            org.a2aproject.sdk.compat03.spec.Message.Role.AGENT,
            List.of(new org.a2aproject.sdk.compat03.spec.TextPart("Agent response")),
            "msg-002",
            "ctx-001",
            "task-001",
            null,
        ...
        org.a2aproject.sdk.compat03.spec.Task v03Task = new org.a2aproject.sdk.compat03.spec.Task(
            "task-001",
            "ctx-001",
            v03Status,
            List.of(v03Artifact),
        ...
        // Convert v0.3 → v1.0
        Task v10Task = TaskMapper.INSTANCE.toV10(v03Task);
        ...
        org.a2aproject.sdk.compat03.spec.Task v03TaskRoundTrip = TaskMapper.INSTANCE.fromV10(v10Task);
        ...
        assertEquals(org.a2aproject.sdk.compat03.spec.TaskState.WORKING, v03TaskRoundTrip.getStatus().state());
    ...
    void testMinimalTaskConversion() {
        ...
        org.a2aproject.sdk.compat03.spec.TaskStatus v03Status = new org.a2aproject.sdk.compat03.spec.TaskStatus(
            org.a2aproject.sdk.compat03.spec.TaskState.SUBMITTED
        );
        ...
        assertEquals(org.a2aproject.sdk.compat03.spec.TaskState.SUBMITTED, v03TaskRoundTrip.getStatus().state());
    }

    @Test
    void testNullTaskConversion() {
        // Null safety
        assertNull(TaskMapper.INSTANCE.toV10(null));
        assertNull(TaskMapper.INSTANCE.fromV10(null));
    }
}
