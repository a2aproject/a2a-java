 ...
 * @see org.a2aproject.sdk.spec.TaskIdParams
 */
...
public interface TaskIdParamsMapper {
     ...
     */
    TaskIdParamsMapper INSTANCE = A03Mappers.getMapper(TaskIdParamsMapper.class);
     ...
     */
    default org.a2aproject.sdk.spec.TaskIdParams toV10(org.a2aproject.sdk.compat03.spec.TaskIdParams v03) {
        if (v03 == null) {
            return null;
        }
        return new org.a2aproject.sdk.spec.TaskIdParams(v03.id(), "");
    }
     ...
     */
    default org.a2aproject.sdk.compat03.spec.TaskIdParams fromV10(org.a2aproject.sdk.spec.TaskIdParams v10) {
        if (v10 == null) {
            return null;
        }
        return new org.a2aproject.sdk.compat03.spec.TaskIdParams(v10.id(), null);
    }
}
