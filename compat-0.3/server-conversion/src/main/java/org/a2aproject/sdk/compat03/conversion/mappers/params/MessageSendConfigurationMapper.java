...
public interface MessageSendConfigurationMapper {
     ...
     */
    MessageSendConfigurationMapper INSTANCE = A03Mappers.getMapper(MessageSendConfigurationMapper.class);
    ...
    default MessageSendConfiguration toV10(
            org.a2aproject.sdk.compat03.spec.MessageSendConfiguration v03) {
        if (v03 == null) {
            return null;
        }

        // Convert PushNotificationConfig to TaskPushNotificationConfig if present
        org.a2aproject.sdk.spec.TaskPushNotificationConfig taskPushConfig = null;
        if (v03.pushNotificationConfig() != null) {
            // Wrap the push notification config with an empty taskId (will be set by the server)
            org.a2aproject.sdk.compat03.spec.TaskPushNotificationConfig v03TaskConfig =
                new org.a2aproject.sdk.compat03.spec.TaskPushNotificationConfig(
                    "",  // Empty taskId - will be populated by server
                    v03.pushNotificationConfig()
                );
            taskPushConfig = TaskPushNotificationConfigMapper.INSTANCE.toV10(v03TaskConfig);
        }
     ...
     */
    default org.a2aproject.sdk.compat03.spec.MessageSendConfiguration fromV10(
        ...
        org.a2aproject.sdk.compat03.spec.PushNotificationConfig pushConfig = null;
        if (v10.taskPushNotificationConfig() != null) {
            org.a2aproject.sdk.compat03.spec.TaskPushNotificationConfig v03TaskConfig =
                TaskPushNotificationConfigMapper.INSTANCE.fromV10(v10.taskPushNotificationConfig());
        ...
        return new org.a2aproject.sdk.compat03.spec.MessageSendConfiguration(
