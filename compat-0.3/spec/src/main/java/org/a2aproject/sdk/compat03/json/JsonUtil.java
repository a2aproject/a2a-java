...
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.CONTENT_TYPE_NOT_SUPPORTED_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.INTERNAL_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.INVALID_AGENT_RESPONSE_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.INVALID_PARAMS_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.INVALID_REQUEST_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.JSON_PARSE_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.METHOD_NOT_FOUND_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.PUSH_NOTIFICATION_NOT_SUPPORTED_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.TASK_NOT_CANCELABLE_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.TASK_NOT_FOUND_ERROR_CODE;
import static org.a2aproject.sdk.compat03.spec.A2AErrorCodes.UNSUPPORTED_OPERATION_ERROR_CODE;
...
import static org.a2aproject.sdk.compat03.json.JsonUtil.JSONRPCErrorTypeAdapter.THROWABLE_MARKER_FIELD;
        ...
        private JSONRPCError createErrorInstance(@Nullable Integer code, @Nullable String message, @Nullable Object data) {
            ...
            return switch (code) {
                ...
                case INTERNAL_ERROR_CODE ->
                    new org.a2aproject.sdk.compat03.spec.InternalError(code, message, data);
