...
public class ToProtoTest {
    ...
    public void convertAgentCard() {
        AgentCard agentCard = new AgentCard.Builder()
                ...
                .build();
        org.a2aproject.sdk.compat03.grpc.AgentCard result = ProtoUtils.ToProto.agentCard(agentCard);
...
//                .iconUrl("http://example.com/icon.svg")
    ...
    public void convertTask() {
        Task task = new Task.Builder().id("cancel-task-123")
                ...
                .build();
        org.a2aproject.sdk.compat03.grpc.Task result = ProtoUtils.ToProto.task(task);
    ...
    public void convertMessage() {
        org.a2aproject.sdk.compat03.grpc.Message result = ProtoUtils.ToProto.message(SIMPLE_MESSAGE);
    ...
    public void convertTaskPushNotificationConfig() {
        TaskPushNotificationConfig taskPushConfig = new TaskPushNotificationConfig("push-task-123",
                new PushNotificationConfig.Builder()
                        ...
                        .id("xyz")
                        .build());
        org.a2aproject.sdk.compat03.grpc.TaskPushNotificationConfig result = ProtoUtils.ToProto.taskPushNotificationConfig(taskPushConfig);
    ...
    public void convertTaskArtifactUpdateEvent() {
        TaskArtifactUpdateEvent task = new TaskArtifactUpdateEvent.Builder()
                ...
                .artifact(new Artifact.Builder()
                        ...
                        .parts(new TextPart("text"))
                        .build()).build();
        org.a2aproject.sdk.compat03.grpc.TaskArtifactUpdateEvent result = ProtoUtils.ToProto.taskArtifactUpdateEvent(task);
    ...
    public void convertTaskStatusUpdateEvent() {
        TaskStatusUpdateEvent tsue = new TaskStatusUpdateEvent.Builder()
                ...
                .isFinal(true)
                .build();
        org.a2aproject.sdk.compat03.grpc.TaskStatusUpdateEvent result = ProtoUtils.ToProto.taskStatusUpdateEvent(tsue);
    ...
    public void convertTaskTimestampStatus() {
        ...
        org.a2aproject.sdk.compat03.grpc.Task grpcTask = ProtoUtils.ToProto.task(task);
