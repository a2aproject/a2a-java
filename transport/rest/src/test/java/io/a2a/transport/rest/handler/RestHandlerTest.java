...
public class RestHandlerTest extends AbstractA2ARequestHandlerTest {
    ...
    public void testGetTaskSuccess() {
        ...
        RestHandler.HTTPRestResponse response = handler.getTask(MINIMAL_TASK.getId(), callContext);
    ...
    public void testGetTaskNotFound() {
        ...
        RestHandler.HTTPRestResponse response = handler.getTask("nonexistent", callContext);
    ...
    public void testHttpStatusCodeMapping() {
        ...
        response = handler.getTask("nonexistent", callContext);
        Assertions.assertEquals(404, response.getStatusCode());
    }
