...
public class RestHandlerTest extends AbstractA2ARequestHandlerTest {
    ...
    public void testPushNotificationConfigSuccess() {
        ...
        RestHandler.HTTPRestResponse response = handler.setTaskPushNotificationConfiguration(callContext, "", requestBody, MINIMAL_TASK.id());
    ...
    public void testGetPushNotificationConfig() {
        ...
        RestHandler.HTTPRestResponse response = handler.setTaskPushNotificationConfiguration(callContext, "", createRequestBody, MINIMAL_TASK.id());
        Assertions.assertEquals(201, response.getStatusCode(), response.toString());
        Assertions.assertEquals("application/json", response.getContentType());
        // Now get it
