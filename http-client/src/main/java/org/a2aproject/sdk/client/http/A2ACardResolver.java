...
public class A2ACardResolver {
    ...
    private AgentCard fetchAgentCard(String url) throws A2AClientError, A2AClientJSONError {
        ...
        if (parsedV10Card != null && supportedProtocolVersions.contains("1.0")
                && parsedV10Card.supportedInterfaces().stream()
                    .anyMatch(i -> "1.0".equals(normalizeCardVersion(i.protocolVersion())))) {
